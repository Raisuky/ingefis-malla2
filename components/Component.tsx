...
const subjects: Subject[] = [
  ...
  { code: "25001", name: "Introducción a la Física", semester: 1, description: "Fundamentos básicos de la física", prerequisites: [], hours: 6, credits: 12 }, // Anual
  { code: "25002", name: "Cálculo", semester: 1, description: "Cálculo básico e integral", prerequisites: [], hours: 6, credits: 12 }, // Anual
  { code: "25003", name: "Álgebra", semester: 1, description: "Estructuras algebraicas fundamentales", prerequisites: [], hours: 6, credits: 12 }, // Anual
  { code: "25053", name: "Física Experimental I", semester: 1, description: "Laboratorio introductorio de física", prerequisites: [], hours: 8, credits: 8 }, // Anual
  ...
  { code: "25024", name: "Técnicas Experimentales I", semester: 6, description: "", prerequisites: ["25014"], hours: 4, credits: 4},
  ...
  { code: "25029", name: "Técnicas Experimentales II", semester: 7, description: "", prerequisites: ["25024"], hours: 4, credits: 4},
